...
class Order_item extends DB{
    ...
    public function add_order_item($ma_sp,$ma_dh,$size,$soluong,$giasp,$loai_mau)
    {
        $sql="insert into order_item(`ma_sp`, `ma_dh`, `size`, `soluong`, `giasp`,`loai_mau`) VALUES ('$ma_sp','$ma_dh','$size','$soluong','$giasp','$loai_mau')";
